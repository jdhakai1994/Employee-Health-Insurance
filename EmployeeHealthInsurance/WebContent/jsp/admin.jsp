				...
				<div class="menu-list">
  		            <ul id="menu-content" class="menu-content">
                		...
                		<ul class="sub-menu collapse in" id="registration">
                    		...
                    		<li><a href="#">Approve Dependent Registration</a></li>
                    	</ul>
                		...
                		<ul class="sub-menu collapse in" id="claims">
                    		<li><a href="#">Approve Domiciliary Claims</a></li>
                    		<li><a href="#">Approve Hospitalization Claims</a></li>
                		...
                		<ul class="sub-menu collapse in" id="hospitals">
                    		...
                    		<li><a href="#">Update Hospital</a></li>
